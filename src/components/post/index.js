...
export default function Post({content}) {
  ...
  const handleFocus = () => commentValue.current.focus();
  ...
  return (
    <div className='rounded col-span-4 border bg-white border-gray-primary mb-8'>
      ...
      <Comments docId={content.docId} comments={content.comments} posted={content.dateCreated} commentValue={commentValue}/>
    </div>
  )
}
